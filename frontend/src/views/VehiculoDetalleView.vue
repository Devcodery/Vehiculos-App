    ...
    <div class="dashboard-wrapper">
        ...
        <div v-else class="grid-2-col">
            ...
            <section class="telemetry-panel">
                ...
                <!-- History of Interventions Table -->
...
const cocheId = route.params.id // Captura la matrícula o ID desde la URL
...
const fetchData = async () => {
    try {
        // 1. Obtenemos los datos del coche
        const cocheRes = await api.get(`/vehiculos/${cocheId}`)
        formulario.value = cocheRes.data

        // 2. Obtenemos TODOS los servicios y filtramos los de este coche
        ...
        historialVehiculo.value = revisionesRes.data
            ...
            .sort((a, b) => b.kilometro_servicio - a.kilometro_servicio) // Ordenar del más reciente al más antiguo por KM
...
const planMantenimiento = computed(() => {
    ...
    return tiposRevision.value.map(tipo => {
        // Buscar la última intervención de este tipo para este vehículo
